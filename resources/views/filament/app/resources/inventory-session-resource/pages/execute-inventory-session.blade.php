    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-5">
            ...
            >
                <div class="flex gap-2">
                    ...
                    <button
                        ...
                        :class="scanning ? 'bg-danger-600 hover:bg-danger-700' : 'bg-gray-600 hover:bg-gray-700'"
                    ...
                    <button
                        ...
                        class="inline-flex items-center rounded-lg bg-primary-600 px-3 py-2 text-white shadow-sm transition hover:bg-primary-700"
                        type="button"
                    >
        ...
        <div class="lg:col-span-2 space-y-4">
            ...
            <button
                ...
                wire:confirm="This will mark all unscanned items as missing and complete the session. Continue?"
            ...
            {{-- Back to Session --}}
            <a
                href="{{ \App\Filament\App\Resources\InventorySessionResource::getUrl('view', ['record' => $this->record]) }}"
